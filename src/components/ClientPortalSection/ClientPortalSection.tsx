...
const features = [
  {
    ...
    desc: "Connect instantly with our design team to collaborate on your project.",
  },
  {
  ...
  },
  {
    ...
    desc: "`Start new projects with one click-submit job details, upload files, request PE seals or request Instaquotes directly in the portal, cutting setup time and keeping your pipeline moving. `.",
  },
  {
    icon: <Bell className="w-8 h-8 text-[var(--color-logo)]" />,
    title: "Instant Design Status Updates",
    desc: "Track every phase of your design project in real time, with Al-driven notifications alerting you to RFI's, milestones, and approvals.",
  },
  {
    icon: <FileText className="w-8 h-8 text-[var(--color-logo)]" />,
    title: "Streamlined Submittal Tracking",
    desc: "Monitor permitting progress with automated updates, leveraging our advanced software to ensure 99% first-pass approval rates and up to 40% faster AHJ approvals, keeping your projects ahead of schedule. ",
  },
  {
...
const ClientPortalSection = () => {
  return (
    ...
    >
      ...
      >
        Say goodbye to endless and lost emails chains and hello to ProTech's
        secure, Al-powered client portal-designed to streamline collaboration
        and make managing fire protection projects effortless.
      </motion.p>
